...
namespace MultiThreading
{
    public class MailManager
    {
        ...
        private readonly ConcurrentDictionary<MailProviderType,BaseProvider> mailProviders 
            = new ConcurrentDictionary<MailProviderType,BaseProvider>();
        ...
        private BaseProvider GetProvider(MailProviderType providerType)
        {
            return mailProviders.GetOrAdd(providerType, p => MailProviderFactory.CreateProvider(providerType));
        }
